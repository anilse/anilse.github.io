...
#align(center)[
  ...
  #text(8pt, fill: light-gray)[
    #link("mailto:" + data.contact.email)[#data.contact.email.replace("@", "\@")] #h(4pt)·#h(4pt) #data.contact.phone #h(4pt)·#h(4pt) #link(data.contact.linkedin)[linkedin.com/in/#data.contact.linkedinHandle] #h(4pt)·#h(4pt) #data.contact.location
  ]
]
#v(4pt)
